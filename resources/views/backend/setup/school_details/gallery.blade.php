                                ...
                                <div class="add_item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage1" src="{{ url('upload/gallery/'.$image1->name) }}" style="height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div> <!-- // end form group -->
                                        </div> <!-- End col-md-3 -->
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage2" src="{{ url('upload/gallery/'.$image2->name) }}" style="height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div> <!-- // end form group -->
                                        </div> <!-- End col-md-3 -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage3" src="{{ url('upload/gallery/'.$image3->name) }}" style="height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div> <!-- // end form group -->
                                        </div> <!-- End col-md-3 -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage4" src="{{ url('upload/gallery/'.$image4->name) }}" style="height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div> <!-- // end form group -->
                                        </div> <!-- End col-md-3 -->
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage5" src="{{ url('upload/gallery/'.$image5->name) }}" style="height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div> <!-- // end form group -->
                                        </div> <!-- End col-md-3 -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <img id="showImage6" src="{{ url('upload/gallery/'.$image6->name) }}" style="height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div> <!-- // end form group -->
                                        </div> <!-- End col-md-3 -->
                                    </div>
